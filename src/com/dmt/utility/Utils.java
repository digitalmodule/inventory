...
public class Utils
{
	static final Logger logger = LoggerFactory.getLogger(com.dmt.utility.Utils.class);
	...
	public static int parseInt(Object obj)
	{
		...
		{
			logger.info("common.Utils.java ::Exception while converting a string value to integer");
			nfe.printStackTrace();
			return numValue;
		}
		return numValue;
